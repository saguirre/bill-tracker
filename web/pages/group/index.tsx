...
export default function GroupView({ user, groupId }: InferGetServerSidePropsType<typeof getServerSideProps>) {
...
export const getServerSideProps = withIronSessionSsr(function ({ req, res, params }) {
  ...
  return {
    props: { user, groupId: params?.groupId },
  };
}, sessionOptions);
